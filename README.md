...
Signal turns email-native procurement reality into a chartable operating map: source evidence becomes extracted workflow state, workflow state becomes a DAG of real procurement surfaces and content packets, and the protocol lets an agent generate validated chart data over that substrate.
