...
export const acmeBaseSandbox: AcmeBaseSandbox = {
  ...
  logs: [
      ...
      {
        timestamp: "2026-05-14T17:03:55.118Z",
        provider: "cloudwatch",
        service: "email-ingestor",
        env: "demo",
        severity: "warn",
        ...
        attributes: {
          ...
          supplier_display_name: "Northstar Sweeteners LLC",
          ingredient_display_name: "rice syrup blend",
          extracted_fields: ["incoterms", "freight_terms"],
          incoterms: "FOB",
      ...
      {
        timestamp: "2026-05-14T17:04:00.921Z",
        provider: "otel",
        service: "document-extractor",
        env: "demo",
        severity: "warn",
        ...
        attributes: {
          ...
          extracted_fields: ["unit_price", "moq"],
      ...
      {
        timestamp: "2026-05-14T17:04:03.209Z",
        provider: "datadog",
        service: "web-app",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:05:18.662Z",
        provider: "datadog",
        service: "document-extractor",
        env: "demo",
        severity: "warn",
        ...
        attributes: {
          ...
          missing_fields: ["allergen_statement"],
          extraction_confidence: 0.83,
        },
      },
      {
        timestamp: "2026-05-14T17:05:24.901Z",
        provider: "otel",
        service: "rfp-workflow",
        env: "demo",
        severity: "info",
        ...
        attributes: {
          ...
          supplier_display_name: "Evergreen Grain Co.",
          ingredient_display_name: "rolled oats",
          requested_fields: ["lead_time", "coa", "allergen_statement"],
        },
      },
      {
      ...
      {
        timestamp: "2026-05-14T17:12:20.118Z",
        provider: "datadog",
        service: "document-extractor",
        env: "demo",
        severity: "warn",
      ...
      {
        timestamp: "2026-05-14T17:12:39.506Z",
        provider: "otel",
        service: "document-extractor",
        env: "demo",
        severity: "warn",
        ...
        attributes: {
          ...
          supplier_display_name: "Northstar Sweeteners",
          ingredient_display_name: "rice syrup blend",
          duplicate_candidate_document_ids: ["doc_tmp_7f4a"],
      ...
      {
        timestamp: "2026-05-14T17:12:44.810Z",
        provider: "datadog",
        service: "web-app",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:14:02.771Z",
        provider: "cloudwatch",
        service: "email-ingestor",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:14:04.188Z",
        provider: "otel",
        service: "email-ingestor",
        env: "demo",
        severity: "warn",
      ...
      {
        timestamp: "2026-05-14T17:14:07.932Z",
        provider: "datadog",
        service: "document-extractor",
        env: "demo",
        severity: "warn",
        ...
        attributes: {
          ...
          document_type_guess: "organic_certification",
          supplier_display_name: "Northstar Sweeteners",
          extracted_fields: ["certificate_type", "issuer", "scope"],
          missing_fields: ["effective_date", "expiration_date", "signature"],
          watermark_text_detected: "draft",
          extraction_confidence: 0.74,
        },
      },
      {
        timestamp: "2026-05-14T17:14:18.409Z",
        provider: "cloudwatch",
        service: "email-ingestor",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:14:21.016Z",
        provider: "otel",
        service: "document-extractor",
        env: "demo",
        severity: "warn",
      ...
      {
        timestamp: "2026-05-14T17:15:08.112Z",
        provider: "cloudwatch",
        service: "email-ingestor",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:15:12.634Z",
        provider: "datadog",
        service: "document-extractor",
        env: "demo",
        severity: "info",
        ...
        attributes: {
          ...
          sheet_names: ["May Quote", "Freight", "Archive"],
      ...
      {
        timestamp: "2026-05-14T17:15:17.982Z",
        provider: "otel",
        service: "document-extractor",
        env: "demo",
        severity: "warn",
        ...
        attributes: {
          ...
          supplier_display_name: "Cascadia Syrups",
          ingredient_display_name: "tapioca syrup",
          detected_price_units: ["per_lb", "per_drum"],
          detected_moq_units: ["pallet", "drum"],
          low_confidence_fields: ["price_unit", "moq_unit"],
          row_match_confidence: 0.64,
        },
      },
      {
        timestamp: "2026-05-14T17:16:01.533Z",
        provider: "cloudwatch",
        service: "email-ingestor",
        env: "demo",
        severity: "warn",
      ...
      {
        timestamp: "2026-05-14T17:16:19.777Z",
        provider: "cloudwatch",
        service: "email-ingestor",
        env: "demo",
        severity: "error",
      ...
      {
        timestamp: "2026-05-14T17:16:47.040Z",
        provider: "otel",
        service: "rfp-workflow",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:17:03.261Z",
        provider: "datadog",
        service: "web-app",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:17:08.804Z",
        provider: "datadog",
        service: "web-app",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:18:33.612Z",
        provider: "cloudwatch",
        service: "email-ingestor",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:18:37.069Z",
        provider: "datadog",
        service: "document-extractor",
        env: "demo",
        severity: "warn",
      ...
      {
        timestamp: "2026-05-14T17:18:41.455Z",
        provider: "otel",
        service: "document-extractor",
        env: "demo",
        severity: "warn",
        ...
        attributes: {
          ...
          candidate_scores: [0.87, 0.79],
          low_confidence_fields: ["supplier_name"],
        },
      },
      {
        timestamp: "2026-05-14T17:20:06.100Z",
        provider: "otel",
        service: "search-indexer",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:22:48.930Z",
        provider: "datadog",
        service: "web-app",
        env: "demo",
        severity: "info",
      ...
      {
        timestamp: "2026-05-14T17:24:15.203Z",
        provider: "cloudwatch",
        service: "email-ingestor",
        env: "demo",
        severity: "warn",
  ...
  metrics: [
      ...
      {
        timestamp: "2026-05-14T17:25:00.000Z",
        provider: "datadog",
        service: "web-app",
        env: "demo",
  ...
  traces: [
      ...
      },
      {
        ...
        name: "SES ReceiveMessage",
        kind: "consumer",
        startTime: "2026-05-14T17:14:02.741Z",
        durationMs: 1447,
        status: "ok",
        attributes: {
          "messaging.system": "aws.ses",
      ...
      },
      {
        ...
        name: "ParseReplyBody",
        kind: "internal",
        startTime: "2026-05-14T17:14:03.884Z",
        durationMs: 304,
        status: "ok",
        attributes: {
          "email.thread_id": "thread-9d1c",
      ...
      },
      {
        ...
        name: "ExtractCertificationFields",
        kind: "consumer",
        startTime: "2026-05-14T17:14:04.226Z",
        durationMs: 3706,
        status: "ok",
        attributes: {
      ...
      },
      {
        ...
        name: "SES ReceiveMessage",
        kind: "consumer",
        startTime: "2026-05-14T17:14:18.375Z",
        durationMs: 2641,
        status: "ok",
        attributes: {
          "messaging.system": "aws.ses",
      ...
      },
      {
        ...
        kind: "internal",
        startTime: "2026-05-14T17:14:20.761Z",
        durationMs: 255,
        status: "ok",
        attributes: {
      ...
      },
      {
        ...
        name: "SES ReceiveMessage",
        kind: "consumer",
        startTime: "2026-05-14T17:15:08.079Z",
        durationMs: 9903,
        status: "ok",
        attributes: {
          "messaging.system": "aws.ses",
      ...
      },
      {
        ...
        kind: "consumer",
        startTime: "2026-05-14T17:15:09.118Z",
        durationMs: 3516,
        status: "ok",
        attributes: {
      ...
      },
      {
        ...
        name: "ExtractQuoteRows",
        kind: "internal",
        startTime: "2026-05-14T17:15:12.719Z",
        durationMs: 5263,
        status: "ok",
        attributes: {
          "document.id": "doc_tmp_quote_cascadia_019",
          "quote.row_count": 5,
          "quote.detected_price_units": ["per_lb", "per_drum"],
          "quote.row_match_confidence": 0.64,
        },
        events: [
          {
            timestamp: "2026-05-14T17:15:17.113Z",
            name: "quote.unit_basis.inconsistent",
            attributes: {
              fields: ["price_unit", "moq_unit"],
              supplier_domain: "cascadia-syrups.example",
            },
          },
        ],
      },
      {
        ...
        kind: "producer",
        startTime: "2026-05-14T17:16:18.911Z",
        durationMs: 866,
        status: "error",
        attributes: {
      ...
      },
      {
        ...
        kind: "internal",
        startTime: "2026-05-14T17:16:46.928Z",
        durationMs: 112,
        status: "ok",
        attributes: {
      ...
      },
      {
        ...
        name: "SES ReceiveMessage",
        kind: "consumer",
        startTime: "2026-05-14T17:18:33.580Z",
        durationMs: 7875,
        status: "ok",
        attributes: {
          "messaging.system": "aws.ses",
      ...
      },
      {
        ...
        kind: "consumer",
        startTime: "2026-05-14T17:18:34.772Z",
        durationMs: 2297,
        status: "ok",
        attributes: {
      ...
      },
      {
        ...
        name: "ExtractCertificationFields",
        kind: "consumer",
        startTime: "2026-05-14T17:18:37.240Z",
        durationMs: 4215,
        status: "ok",
        attributes: {
      ...
      },
      {
        ...
        kind: "client",
        startTime: "2026-05-14T17:20:06.010Z",
        durationMs: 90,
        status: "ok",
        attributes: {
          "db.system": "opensearch",
